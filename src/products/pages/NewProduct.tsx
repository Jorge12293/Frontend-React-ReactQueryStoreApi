...
export const NewProduct = () => {
  ...
  const { control, handleSubmit, watch } = useForm<FormInputs>({
    defaultValues: {
      title: "Teclado",
      price: 120,
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis, nobis quos! Quaerat, id obcaecati. Magnam alias perspiciatis aperiam corporis dolore, adipisci natus quidem quibusdam. Soluta eos incidunt iusto perspiciatis et!",
      category: "men's clothing",
      image: "https://th.bing.com/th/id/OIP.IDjZudxpqOH-RYYndv3ZrgHaDg"
    }
  })
        ...
        <div className="flex justify-around items-center">
          ...
          <div className="flex-col w-[500px]">
            ...
            <Button type="submit" className="mt-2" color="primary" isDisabled={productMutation.isPending}>
              {productMutation.isPending ? 'Loading....' : 'Create Product'}
            </Button>
          </div>
